...
class InstallWindow(QWidget):
    def __init__(self):
        ...
        self.input_db_password.setText("vehicle password")
        ...
        buttonsave.setStyleSheet("padding:5px;font-size:17px;background:green;color:#0000FF")
    ...
    def showStepInfo(self):
        ...
        dBOperation.InsertAdmin(self.input_admin_username.text(), self.input_db_password.text())
